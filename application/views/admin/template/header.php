				...
				<div class="d-flex">
					...
					<div class="navbar-brand-box">
						<a href="<?= base_url() ?>" class="logo logo-light">
							<span class="logo-sm">
								<!--<img src="<?= base_url('assets/admin/images/logo.png') ?>" alt="Kritosh" height="22">-->
								<h3><?= $setting[9]['content_value'] ?></h3>
							</span>
							<span class="logo-lg">
								<h4 style="color: #fff; margin-top: 20px;"><?= $setting[9]['content_value'] ?></h4>
							</span>
						</a>
					</div>
