...
define('RAZOR_PAY_KEY', 'rzp_test_a2t70YMbLw5blz');
define('RAZOR_PAY_SECRET', 'qFkLgxnthrmomhIlhTNAzfdd');



if (PRODUCT_ENVIRONMENT == 'PROD') {
    define('PHONEPEURL', "https://api.phonepe.com/apis/hermes/pg/v1/pay");
} else {
    define('PHONEPEURL', "https://api-preprod.phonepe.com/apis/pg-sandbox/pg/v1/pay");
}
